...
const CreateProductForm = () => {
    ...
    return (
        <motion.div
            ...
            className="bg-slate-900 px-4 md:px-8 md:pt-4 pb-8 rounded-lg shadow-lg w-[90%] max-w-118 transition-all duration-200 mb-10"
        >
            <h2 className=" text-lg md:text-xl font-bold text-center text-pink-500 py-4">Create New Product</h2>
